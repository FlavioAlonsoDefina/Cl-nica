...
public class MenuPrincipalUI extends javax.swing.JFrame {
    ...
    public MenuPrincipalUI() {
        ...
        JButton btnMedico = new JButton("Ingresar como Médico");
        JButton btnPaciente = new JButton("Ingresar como Paciente");

        btnMedico.setBounds(100, 40, 200, 30);
        btnPaciente.setBounds(100, 90, 200, 30);
